...
def detect_tomatoes(frame, model):
    ...
    for contour in contours:
        ...
        if area > 100:
            ...
            # Use the model to predict whether the tomato is healthy or unhealthy
            ...
            label = "Healthy" if prediction > 0.5 else "Mold(Unhealthy tomato)"
    ...
    # Display the result
    cv2.imshow("Tomato Pathoscan", frame)
